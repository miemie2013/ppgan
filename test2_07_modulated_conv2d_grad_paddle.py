...
for batch_idx in range(8):
    ...
    y, x_1, x_2 = modulated_conv2d(x, w, styles, noise, up=up, down=down, padding=padding, resample_filter=resample_filter,
    ...
    dy_dx, dy_dstyles = modulated_conv2d_grad(dysum_dy, x_1, x_2, x, w, styles, noise, up=up, down=down, padding=padding, resample_filter=resample_filter,
                                              demodulate=demodulate, flip_weight=flip_weight, fused_modconv=fused_modconv)
