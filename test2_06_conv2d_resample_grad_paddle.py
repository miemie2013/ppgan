...
for batch_idx in range(8):
    ...
    y = conv2d_resample(x, w, filter=f, up=up, down=down, padding=padding, groups=groups, flip_weight=flip_weight, flip_filter=flip_filter)
    ...
    dy_dx = conv2d_resample_grad(dysum_dy, x, w, filter=f, up=up, down=down, padding=padding, groups=groups, flip_weight=flip_weight, flip_filter=flip_filter)
